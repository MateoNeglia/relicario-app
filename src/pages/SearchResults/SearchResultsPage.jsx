...
//   const handleLike = async (relicId, currentLikedState) => {
//     try {
...
//       setLikedRelics((prev) => ({
//         ...prev,
//         [relicId]: !currentLikedState,
//       }));
//       showNotification('Tu lista de favoritos fue actualizada', 'success');
//     } catch (err) {
//       showNotification(err || 'Hubo un error al agregar la reliquia a favoritos', 'error');      
//     }
//   };
...
//                 const isLiked = likedRelics[relic._id] ?? relic.likes.includes(Cookies.get('userId'));
//                 return (
